  ...
  return (
    <div className="w-full h-full grid grid-cols-6  ">
      ...
      <div className=" col-start-2 col-end-7 py-9 px-6 h-full relative ">
        ...
        <div className=" w-full py-[10px] rounded-[5px] grid grid-cols-2">
          <div className="col-start-1 col-end-2 flex justify-center">
            <div className="bg-[#F5F5F5] h-[120px] w-full rounded-[10px] pl-[26px] flex  mr-[50px] pt-[15px]">
              <button className="h-[40px] w-[110px] rounded-[5px] bg-[#00FF94] font-bold text-[#3C4448]">
                ROOM 101
              </button>
              <div className="ml-[30px]">
                <div className="font-bold">
                  <h1>Room owner: Nguyen Thi Mau (You)</h1>
                  <h1>Roommate: Tran Thi Binh</h1>
                </div>
                <button className="h-[40px] w-[200px] rounded-[5px] bg-[#334155] font-bold text-[#fff] mt-[6px]">
                  ROOM 101
                </button>
              </div>
            </div>
          </div>
          <div className="col-start-2 col-end-4 flex justify-around ">
